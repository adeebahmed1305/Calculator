...
# actual backend calculation done by computer

#this function will make the numbers into string so it can be shown in the calculation box
...
#this function solve the equation given in the calculator
...
#this function will clear out all unwanted numbers and symbols in the calculation box
def clear():
    global calculation
    calculation = ""
    text_result.delete(1.0, "end")
...
btn_2 = tk.Button(root, text="2", command=lambda: add_to_calculation(2), height=1, width=5, font=("Arial", 14))
btn_2.grid(row=2, column = 2)

btn_3 = tk.Button(root, text="3", command=lambda: add_to_calculation(3), height=1, width=5, font=("Arial", 14))
btn_3.grid(row=2, column = 3)

btn_4 = tk.Button(root, text="4", command=lambda: add_to_calculation(4), height=1, width=5, font=("Arial", 14))
...
btn_8 = tk.Button(root, text="8", command=lambda: add_to_calculation(8), height=1, width=5, font=("Arial", 14))
...
btn_minus = tk.Button(root, text="-", command=lambda: add_to_calculation("-"), height=1, width=5, font=("Arial", 14))
btn_minus.grid(row=3, column = 4)

btn_multiply = tk.Button(root, text="*", command=lambda: add_to_calculation("*"), height=1, width=5, font=("Arial", 14))
btn_multiply.grid(row=4, column = 4)

btn_divide = tk.Button(root, text="÷", command=lambda: add_to_calculation("÷"), height=1, width=5, font=("Arial", 14))
